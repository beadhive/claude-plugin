...
- **assurance plane** _(proposed)_ — the cross-cutting gate layer where the warden attaches
  security + policy gates at pre-merge / pre-cut / pre-publish. → [beadflow-and-planes.md](beadflow-and-planes.md)
...
- **delivery plane** _(roadmap)_ — the sequential release → deploy → running plane where the
  operator reconciles desired-state. → [beadflow-and-planes.md](beadflow-and-planes.md)
...
- **integration plane** — the execution plane where dispatcher → developer → merger land a
  molecule on an always-green line. → [beadflow-and-planes.md](beadflow-and-planes.md)
